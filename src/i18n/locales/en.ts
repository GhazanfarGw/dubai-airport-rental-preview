...
const en = {
  ...
  home: {
    categories: { title: 'Choose your drive', subtitle: 'Browse live vehicle categories from the current fleet.', emptyTitle: 'Categories will appear here', emptyBody: 'Our vehicle categories are updated from the live fleet.' },
    faq: { eyebrow: 'Need to know', title: 'Questions, answered', subtitle: 'Clear information before you choose your car.', viewAll: 'View all FAQs' },
    finalCta: { title: 'Ready to find your car?', subtitle: 'Choose your locations and dates to browse the live UAE fleet.', button: 'Find your car' },
    brands: {
  ...
  searchResults: {
    resultsEyebrow: 'Live fleet selection',
    heroTitle: 'Rent a car in the UAE',
    ...
    searchNotConfiguredBody: 'Select your pickup, drop-off, and dates to see live availability and an exact rental quote.',
